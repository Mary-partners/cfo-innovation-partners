...
export const NAV_ITEMS: NavItem[] = [
  ...
  { href: "/work", label: "Work", icon: ListChecks, implemented: true, phase: "Phase 1" },
  ...
  { href: "/calendar", label: "Calendar & Deadlines", icon: CalendarClock, implemented: true, phase: "Phase 1" },
  ...
  { href: "/templates", label: "Templates & Automations", icon: Workflow, implemented: true, phase: "Phase 1" },
